# 🔧 Troubleshooting Guide — Systemd Service Builder
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-systemd-builder/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/systemd-builder/)
